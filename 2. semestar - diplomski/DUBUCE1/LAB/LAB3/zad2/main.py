...
from zad1.glove_embeddings import load_glove_embeddings
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size_test', type=int, default=32, help='batch size for validation and testing')
