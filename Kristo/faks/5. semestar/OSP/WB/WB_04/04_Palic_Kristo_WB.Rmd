...
mjesto3 <- read.csv(sep = ";", "mjestoAlt.csv")
mjesto3
...
mjesto$visokiPrirez <- mjesto$prirez > 12
mjesto
...
mjesto$mjesecniPrihod <- round(mjesto$brojStanovnika * 0.6 * mjesto$prosjPlacaKn * 0.1 * mjesto$prirez / 1000000, 2)
mjesto
...
cbind(df12, imena = c("Ivo", "Ana", "Pero", "Stipe"))
df12
# ispišite okvir df12
...
tlakf3 <- factor(tlak, levels = c("prenizak", "nizak", "normalan", "visok", "previsok"), ordered = TRUE)
