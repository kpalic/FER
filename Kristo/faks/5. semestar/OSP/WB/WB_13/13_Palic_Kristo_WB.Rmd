...
qbinom(p = c(0.25, 0.5, 0.75), 100, 0.5)
...
data <- read.csv("./podaci.txt")

g1 <- ggplot(data, aes(x1)) + geom_density() + labs(x = "", title = "Normalna") + xlim(c(160, 180))
g2 <- ggplot(data, aes(x2)) + geom_density() + labs(x = "", title = "Lijevo nagnuta") + xlim(c(170, 176))
g3 <- ggplot(data, aes(x3))+ geom_density() + labs(x = "", title = "Desno nagnuta") + xlim(c(160, 170))
g4 <- ggplot(data, aes(x4)) + geom_density() + labs(x = "", title = "Bimodalna") + xlim(c(90, 190))
...
g1 <- ggplot(data, aes(sample = x1)) + geom_qq() + labs(title = "Normalna")
g2 <- ggplot(data, aes(sample = x2)) + geom_qq() + labs(title = "Lijevo nagnuta")
g3 <- ggplot(data, aes(sample = x3)) + geom_qq() + labs(title = "Desno nagnuta")
g4 <- ggplot(data, aes(sample = x4)) + geom_qq() + labs(title = "Bimodalna")
...
mean(baciNovcic(10))
mean(baciNovcic(100))
mean(baciNovcic(1000))
mean(baciNovcic(1000000))
...
replicate(1000, sample(1:6, 20, T)) %>% t -> rez
